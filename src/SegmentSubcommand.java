...
public class SegmentSubcommand {
  ...
  public SegmentSubcommand(String origin, String destination, String flightNumber, LocalDate departureDate,
      CabinType cabinType, int numPeople) throws SyntacticError, SemanticError {

    if (origin.length() != 3) throw new SyntacticError("Origin invalid.");
    if (origin.equals(destination)) throw new SemanticError("Origin equal to destination.");
